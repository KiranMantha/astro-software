...
export const KarmicDoshas: Record<
  string,
  { nakshatra: string; indications: string; remidies: string }
> = {
  Ashv: {
    nakshatra: 'Ashwini',
    indications:
  ...
  Ardr: {
    ...
    remidies:
      'Perform Pitru Tarpana during Mahalaya Amavasya (Pitru Paksha period) with sincerity.',
  },
  Asre: {
    nakshatra: 'Ashlesha',
    indications:
  ...
  Mool: {
    ...
    remidies:
      'Donate rice to temples, preferably equal to the individual’s body weight.',
  },
  PSha: {
    ...
    remidies:
      'Donate rice to temples, preferably matching the person’s body weight.',
  },
  USha: {
    ...
    remidies:
      'Donate rice to temples, preferably equivalent to the person’s body weight.',
  },
  Dhan: {
    nakshatra: 'Dhanishta',
    indications:
